...
public class Prediction implements Serializable {
    ...
    /**
     * Copy constructor. This is a very shallow copy.
     */
    public Prediction(Prediction copyFrom) {
    	this.id = copyFrom.id;
    	this.fixture = copyFrom.fixture;
    	this.predictedResult = copyFrom.predictedResult;
    	this.predictor = copyFrom.predictor;
    }
